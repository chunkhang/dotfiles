...
function! typescript#open(path) abort
  let l:exts = ['', '.ts', '.tsx', '/index.ts', '/index.tsx']
  for l:ext in l:exts
...
" Go to path for typescript import
function! typescript#gf() abort
